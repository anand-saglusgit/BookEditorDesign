    ...
    >
      ...
      <div className="flex flex-col items-center p-2 mt-1 mb-1">
        <div className="w-10 h-10 rounded-lg bg-[#fff] text-gray-300 flex items-center justify-center">
          ...
          <rect x="0.42" y="0.42" width="29.16" height="29.16" rx="5.58" stroke="black" stroke-opacity="0.15" stroke-width="0.84"/>
          <g clip-path="url(#clip0_69_3142)">
          <path d="M13.0376 7.21986V22.1824C13.0376 23.5596 11.9211 24.6761 10.5438 24.6761H7.21881C5.84155 24.6761 4.72506 23.5596 4.72506 22.1824V7.21986C4.72506 5.8426 5.84155 4.72611 7.21881 4.72611H10.5438C11.9211 4.72611 13.0376 5.8426 13.0376 7.21986ZM22.1813 17.7767H17.1938C15.8165 17.7767 14.7001 18.8932 14.7001 20.2705V22.1824C14.7001 23.5596 15.8165 24.6761 17.1938 24.6761H22.1813C23.5586 24.6761 24.6751 23.5596 24.6751 22.1824V20.2705C24.6751 18.8932 23.5586 17.7767 22.1813 17.7767ZM22.1813 4.72611H17.1938C15.8165 4.72611 14.7001 5.8426 14.7001 7.21986V13.6205C14.7001 14.9977 15.8165 16.1142 17.1938 16.1142H22.1813C23.5586 16.1142 24.6751 14.9977 24.6751 13.6205V7.21986C24.6751 5.8426 23.5586 4.72611 22.1813 4.72611Z" fill="black" fill-opacity="0.3"/>
          </g>
          <defs>
          <clipPath id="clip0_69_3142">
          <rect width="21" height="21" fill="white" transform="translate(4.20016 4.20026)"/>
          </clipPath>
          </defs>
          </svg>
        </div>
      ...
      <div className="flex flex-col items-center p-2">
        <div className="w-10 h-10 rounded-lg bg-[#fff] text-gray-300 flex items-center justify-center">
          ...
          <rect x="0.42" y="0.42" width="29.16" height="29.16" rx="5.58" stroke="black" stroke-opacity="0.15" stroke-width="0.84"/>
          <path d="M6.45679 20.8347L6.43929 20.8522C6.20304 20.3359 6.05429 19.7497 5.99304 19.1022C6.05429 19.7409 6.22054 20.3184 6.45679 20.8347Z" fill="black" fill-opacity="0.3"/>
          <path d="M12.0749 13.2833C13.225 13.2833 14.1573 12.3509 14.1573 11.2008C14.1573 10.0506 13.225 9.11827 12.0749 9.11827C10.9247 9.11827 9.99235 10.0506 9.99235 11.2008C9.99235 12.3509 10.9247 13.2833 12.0749 13.2833Z" fill="black" fill-opacity="0.3"/>
      ...
      <div className="flex flex-col items-center p-2">
        <div className="w-10 h-10 rounded-lg bg-[#fff] text-gray-300 flex items-center justify-center">
          ...
          <rect width="30" height="30" rx="6" fill="black" fill-opacity="0.05"/>
          <rect x="0.42" y="0.42" width="29.16" height="29.16" rx="5.58" stroke="black" stroke-opacity="0.15" stroke-width="0.84"/>
          <path d="M23.5197 15.1194H15.1197V24.3594H23.5197V15.1194Z" fill="black" fill-opacity="0.3"/>
          <path d="M23.8671 7.58645C23.106 6.07764 21.5418 5.04041 19.7396 5.04041C17.1921 5.04041 15.1197 7.11296 15.1197 9.66048C15.1197 12.208 17.1921 14.2804 19.7396 14.2804C21.5418 14.2804 23.106 13.2432 23.8671 11.7344C24.1819 11.1103 24.3597 10.4058 24.3597 9.66033C24.3597 8.91502 24.1819 8.21047 23.8671 7.58645Z" fill="black" fill-opacity="0.3"/>
          <path d="M9.65986 5.04041L5.03979 14.2804H14.2798L9.65986 5.04041Z" fill="black" fill-opacity="0.3"/>
